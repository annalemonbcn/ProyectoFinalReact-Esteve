...
const ItemGridView = ({ imgSrc, imgAlt, name, price, id }) => {
    return (
    <div className="w-full md:w-1/2 lg:w-1/3 lg:p-6 box-border mb-6 lg:mb-0 lg:hover:scale-110 transition duration-300 ease-in-out itemsContainer">
      ...
      <div className="pb-5 px-4 mt-4 lg:mt-6">
        <Link to={`/item/${id}`}>
