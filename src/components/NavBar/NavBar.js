...
//         <div
//           className={
//             (navbarOpen ? "opacity-100 h-screen md:h-auto bg-slate-100 absolute left-0 top-[72px] md:relative md:left-auto md:top-auto" : "opacity-0 md:opacity-100 h-0 md:h-auto") +
//             " lg:opacity-100 transition-all ease-in duration-100 lg:items-center justify-between w-full md:flex md:w-auto md:order-1 md:border-0"
//           }
//           id="menu-list"
//         >
//           {/* Links list */}
